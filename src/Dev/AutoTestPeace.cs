...
namespace MyValheimMod.Dev
{
    ...
    ///
    /// Without this a run is a lottery: a greydwarf wanders in, hits what is under test, and a
    /// check fails for a reason that has nothing to do with the code (ValheimTomrer's flaky
    /// support checks were exactly this). Four levers, all of them the game's own:
    ///
    /// <list type="bullet">
